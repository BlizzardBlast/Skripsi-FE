...
export default function BrewingSectionOne(): JSX.Element {
  return (
    <div
      className={`flex min-h-[70vh] w-full flex-col items-center justify-center text-pretty bg-[url('@/assets/brewing_page_bg.webp')] bg-cover bg-center bg-no-repeat py-5`}
    >
